...
$conf['syntaxNoteMode'] = 'standard';
$conf['syntaxNoteAlign'] = 'center';
$conf['syntaxNoteType'] = 'round';
$conf['syntaxNoteSize'] = '60%';
$conf['syntaxNoteHeading'] = 0;
$conf['syntaxNoteHeadingSize'] = 'H4';
